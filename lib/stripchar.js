...
{
    var replacement = (!this.isLenMinMax(replaceWith) && !this.isSpaces(replaceWith) && !this.isNull(replaceWith)) ? replaceWith : '';     
 ...
 * @param {String|Object, String} input, replaceWith
 * @return {String|Object}
 * Replace OR Strip every thing EXCEPT Small-Capital Alphabets and Numerics
**/
